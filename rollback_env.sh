...
echo "copying code..."
echo "copying web..."
#example cd /var/www/html/release.super_app && git config core.fileMode false && git pull
...
ROLLBACK_SQL_SCRIPT_NEW=${SCRIPT_BASEDIR}"/update_new.sql"
echo "copy Pre generated post installation data file to new"
cp -f ${ROLLBACK_SQL_SCRIPT} ${ROLLBACK_SQL_SCRIPT_NEW}
